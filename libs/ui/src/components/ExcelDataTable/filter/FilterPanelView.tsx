...
export type FilterPanelViewProps = {
 ...
 */
export function FilterPanelView(props: FilterPanelViewProps): React.ReactNode {
	...
	// Enter carries the patched tree up from the row, and is *stored only*.
	//
	// Applying is the Apply button's job alone: a panel that searched on Enter ran a query the user
	// had not finished composing, and there is no way to enter a value into a multi-condition filter
	// without leaving at least one of them momentarily half-written.
