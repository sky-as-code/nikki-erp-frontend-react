...
export const Route = createFileRoute('/_tenant/$tenant/_settings/settings/_users/users/$userId')({
	...
	return (
		...
		>
			<Grid.Col span='auto' className='h-full'>
				...
				<Tabs variant='unstyled' defaultValue='stock-matrix' className='h-full flex flex-col'>
					<TabList>
		...
		renderCell: (props) => {
			...
			return (
				<Stack gap='md' align='center' className='text-center'>
					<Text size='md' fw='bold'>{ String.fromCharCode(65 + props.rowIdx) }</Text>
