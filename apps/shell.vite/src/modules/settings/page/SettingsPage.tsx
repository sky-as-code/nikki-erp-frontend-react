...
// import { PageLayout } from '@nikkierp/ui/components';
// // import {
// // 	DataTable,
// // 	TableContextType,
// // 	createTableContext,
// // } from '@nikkierp/ui/components/Table/DataTable';
// // import { data, columns } from '@nikkierp/ui/components/Table/SimpleTable';
// import {
// 	IconChevronLeft,
// 	IconChevronLeftPipe,
// 	IconChevronRight,
...
// import { useUIState } from '@/context/UIProviders';
...
// 	} = useUIState();
// 	const { context, Provider } = {} as any; //createTableContext({
// 	// name: 'settings.users',
// 	// defaultPageSize: 50,
// 	// fetchFn: async (pagination: any) => {
...
// 	tableContext: React.Context<any>
...
// const TableActions: React.FC<{ ctxVal: any }> = ({ ctxVal }) => {
// 	const {
// 		totalRows,
...
// const TableSettings: React.FC<{ ctxVal: any }> = ({ ctxVal }) => {
// 	return (
