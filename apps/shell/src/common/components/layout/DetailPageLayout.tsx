import { Button, ButtonProps, CloseButton, Group, Text } from '@mantine/core'
import { IconBriefcase, IconDeviceFloppy, IconDots, IconFolders, IconRefresh, IconStar } from '@tabler/icons-react'
...
export const DetailPageLayout: React.FC<DetailPageProps> = ({ component: Component, ...props }) => {
