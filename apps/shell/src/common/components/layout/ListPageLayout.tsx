import {
	ActionIcon,
	Anchor,
	Button, ButtonProps, Group, NativeSelect, Popover, Stack, Switch, Text,
} from '@mantine/core'
...
export const ListPageLayout: React.FC<ListPageProps> = (rawProps) => {
	const {
		enableGrid = true,
		enableTable = true,
		...props
	...
	const { location: { pathname: pathName } } = useRouterState()
