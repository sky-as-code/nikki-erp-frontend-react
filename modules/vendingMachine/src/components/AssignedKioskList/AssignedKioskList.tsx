...
const DEFAULT_I18N = {
	addKiosks: 'nikki.vendingMachine.assignedKioskList.addKiosks',
	empty: 'nikki.vendingMachine.assignedKioskList.empty',
} as const;
			...
			{onAddKiosks && (
				<Group justify='flex-end'>
					<Button
						...
						onClick={onAddKiosks}
					>
						{translate(keys.addKiosks)}
					</Button>
				</Group>
			)}
			{!kiosks || kiosks.length === 0 ? (
				<Text size='sm' c='dimmed' ta='center' py='md'>
					{translate(keys.empty)}
				</Text>
			) : (
