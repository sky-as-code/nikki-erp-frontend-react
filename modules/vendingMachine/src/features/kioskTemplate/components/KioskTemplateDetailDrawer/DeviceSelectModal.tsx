...
export const DeviceSelectModal: React.FC<DeviceSelectModalProps> = ({
	...
	return (
		<Modal
			...
			title={translate('nikki.vendingMachine.kioskTemplate.selectDevice.title')}
			size='xl'
		>
			<Stack gap='md'>
				{/* Search */}
				<TextInput
					placeholder={translate('nikki.vendingMachine.kioskTemplate.selectDevice.searchPlaceholder')}
				...
				<ScrollArea h={400}>
					{filteredDevices.length === 0 ? (
						<Text size='sm' c='dimmed' ta='center' py='md'>
							{translate('nikki.vendingMachine.kioskTemplate.selectDevice.noDevices')}
						</Text>
					) : (
