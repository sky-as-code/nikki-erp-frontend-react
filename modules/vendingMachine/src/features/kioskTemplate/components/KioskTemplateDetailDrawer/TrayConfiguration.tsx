		...
		<Stack gap='md'>
			<div>
				<Text size='sm' c='dimmed' mb='xs' fw={500}>
					{translate('nikki.vendingMachine.kioskTemplate.fields.numberOfTrays')}
				</Text>
				<Select
					...
					data={trayOptions}
					placeholder={translate('nikki.vendingMachine.kioskTemplate.fields.numberOfTrays')}
					clearable
				/>
			</div>
				...
				<div>
					<Group justify='space-between' mb='xs'>
						<Text size='sm' c='dimmed' fw={500}>
							{translate('nikki.vendingMachine.kioskTemplate.fields.trayConfigurations')}
						</Text>
						{selectedRows.size > 0 && (
							<Button
								size='xs'
							...
							>
								{translate('nikki.vendingMachine.kioskTemplate.actions.selectDeviceForSelected', { count: selectedRows.size })}
							</Button>
						)}
					</Group>
						...
						<Table>
							<Table.Thead>
								<Table.Tr>
									...
									<Table.Th>{translate('nikki.vendingMachine.kioskTemplate.fields.trayRow')}</Table.Th>
									<Table.Th>{translate('nikki.vendingMachine.kioskTemplate.fields.trayDevice')}</Table.Th>
									<Table.Th>{translate('nikki.vendingMachine.kioskTemplate.fields.deviceSpecifications')}</Table.Th>
										...
										<Table.Tr key={row} style={{ backgroundColor: isRowSelected ? 'var(--mantine-color-blue-0)' : undefined }}>
											...
											<Table.Td>
												{device ? (
													...
													>
														{translate('nikki.vendingMachine.kioskTemplate.selectDevice.selectDevice')}
													</Button>
												)}
											</Table.Td>
											<Table.Td>
