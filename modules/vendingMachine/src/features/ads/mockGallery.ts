...
// Mock gallery folders structure
export const mockGalleryFolders: GalleryFolder[] = [
	{
		id: 'folder-1',
		name: 'Quảng cáo Thực phẩm',
		mediaCount: 5,
		children: [
			{
				id: 'folder-1-1',
...
export const mockGalleryMedia: GalleryMedia[] = [
	...
	// Media in folder-1-2 (Đồ ăn nhanh)
	{
		id: 'media-4',
		code: 'MED-004',
		name: 'McDonald\'s Ad',
	...
	// Media in folder-2-1 (Điện thoại)
	{
		id: 'media-6',
		code: 'MED-006',
