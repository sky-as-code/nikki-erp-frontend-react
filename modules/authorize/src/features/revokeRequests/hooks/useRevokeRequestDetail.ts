...
function useRevokeRequestDetailHandlers(revokeRequest?: RevokeRequest) {
...
export const useRevokeRequestDetail = {
	detail: useRevokeRequestDetailData,
	handlers: useRevokeRequestDetailHandlers,
};
