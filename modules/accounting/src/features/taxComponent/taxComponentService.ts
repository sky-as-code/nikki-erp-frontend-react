...
/**
 * CRUD over `accounting_tax_component` — one child tax inside a group tax.
 *
 ...
 */
@storeService('TaxComponentService', accountingStore)
export class TaxComponentService extends OrgScopedCrudService {
	public constructor() {
		super({ moduleName: ACCOUNTING_MODULE, schemaName: TAX_COMPONENT_SCHEMA_NAME });
	}
}

export const taxComponentService = new TaxComponentService();
