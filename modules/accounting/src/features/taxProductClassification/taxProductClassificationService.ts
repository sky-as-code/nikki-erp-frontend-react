...
/**
 * CRUD over `accounting_tax_product_classification` — what a product is for tax purposes.
 *
 ...
 */
@storeService('TaxProductClassificationService', accountingStore)
export class TaxProductClassificationService extends OrgScopedCrudService {
	public constructor() {
		super({ moduleName: ACCOUNTING_MODULE, schemaName: TAX_PRODUCT_CLASSIFICATION_SCHEMA_NAME });
	}
}

export const taxProductClassificationService = new TaxProductClassificationService();
