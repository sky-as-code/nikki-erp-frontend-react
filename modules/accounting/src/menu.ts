...
const ITEMS: MenuItem[] = [
	{
		labelKey: 'menu_tax',
		items: [
			{ labelKey: 'menu_taxJurisdictions', link: '/accounting_tax_jurisdiction' },
			{ labelKey: 'menu_taxGroups', link: '/accounting_tax_group' },
			{ labelKey: 'menu_taxClassifications', link: '/accounting_tax_product_classification' },
			{ labelKey: 'menu_taxes', link: '/accounting_tax' },
			{ labelKey: 'menu_taxRates', link: '/accounting_tax_rate_version' },
			{ labelKey: 'menu_taxRules', link: '/accounting_tax_rule' },
			{ labelKey: 'menu_taxMappings', link: '/accounting_tax_mapping' },
			{ labelKey: 'menu_taxRoundingPolicies', link: '/accounting_tax_rounding_policy' },
