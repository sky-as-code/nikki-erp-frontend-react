...
// Warehouse-level reservations. See backend .../inventory/domain/models/inventory_stock_reservation.go.
export const STOCK_RESERVATION_SCHEMA_NAME = 'inventory_stock_reservation';
...
export const STOCK_RESERVATION_RESOURCE_PATH = `v1/inventory/${STOCK_RESERVATION_SCHEMA_NAME}`;
