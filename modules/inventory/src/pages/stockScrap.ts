 ...
 *
 * Unlike the stock balance, this page binds the full set of write actions — a scrap is a document
 ...
 * action went, where a refusal names the reason. See BR §4.2.9.
 */
...
function buildStockScrapDetailProps() {
	return resourceDetailProps({
		...
		formSections: [{
			...
			// Empty until a lot, package or owner narrows which goods are scrapped — a read-mode
